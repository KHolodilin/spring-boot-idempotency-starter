...
/**
 * Demo smoke tests: the application consumes the reactive starter exactly like an
 * external application would. Redis is intentionally unavailable to also verify the
 * fail-open distributed cache behaviour.
 */
@Testcontainers
