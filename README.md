...
```kotlin
implementation("com.kholodilin:spring-boot-idempotency-starter:0.3.5")

// optional caches
implementation("com.kholodilin:idempotency-local-cache-caffeine:0.3.5")
implementation("com.kholodilin:idempotency-distributed-cache-redis:0.3.5")
```
