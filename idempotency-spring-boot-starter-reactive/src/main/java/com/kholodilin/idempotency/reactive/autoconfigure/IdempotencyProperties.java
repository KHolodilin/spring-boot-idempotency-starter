...
/**
 * Configuration properties of the reactive idempotency starter, prefix {@code idempotency}.
 */
@Getter
@Setter
...
public class IdempotencyProperties {
     ...
     * Named distinctly from the SPI {@code ReactiveDistributedCache} type.
     */
    @Getter
    @Setter
    public static class DistributedCacheSettings {
        ...
        /**
         * Enable the Redis distributed cache (requires
         * idempotency-distributed-cache-redis-reactive on the classpath and a
    ...
    public static class Persistence {
        ...
        /**
         * Enable the R2DBC persistence store.
         */
        private boolean enabled = true;
         ...
         * {@code expires_at}, wire {@code DefaultReactiveIdempotencyServiceBuilder#persistenceTtl(null)}.
         */
